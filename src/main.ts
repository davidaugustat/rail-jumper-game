...
<header class="topbar"><a class="brand" href="./" aria-label="RailJumper home"><span class="brand-icon">↟</span> RAILJUMPER</a><button id="sound" class="icon-button" aria-label="Mute sound" title="Mute sound"></button></header>
