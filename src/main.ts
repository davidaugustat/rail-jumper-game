...
<section id="welcome" class="welcome"><div class="eyebrow"><span></span> A LITTLE SPEED. A LOT OF SUNSHINE.</div><h1>Next stop:<br><em>full speed.</em></h1><p>Three tracks. Endless possibilities.<br>Dodge the trains, chase the coins,<br>and see how far you can go.</p><button id="start" class="primary">LET’S RUN <span>↗</span></button><div class="start-note">PRESS ENTER TO HIT THE TRACKS</div><div class="best-line"><span>♜</span><div>YOUR PERSONAL BEST<strong id="welcome-best">0 <small>PTS</small></strong></div></div></section>
<div id="scene-sticker" class="scene-sticker"><span>ONE MORE RUN?</span><strong>Always.</strong><svg width="75" height="26" viewBox="0 0 75 26" aria-hidden="true"><path d="M3 7 Q32 0 66 16 M54 4 L68 17 L51 22" fill="none" stroke="currentColor" stroke-width="2"/></svg></div>
...
<section class="controls" aria-label="How to play"><div class="controls-title"><span>THE BASICS</span><strong>Find your rhythm.</strong></div><div class="control"><div class="keys"><kbd>←</kbd><kbd>→</kbd></div><div><strong>Switch tracks</strong><span>Make your next move</span></div></div><div class="control"><kbd>↑</kbd><div><strong>Jump</strong><span>Clear the low barriers</span></div></div><div class="control"><kbd>↓</kbd><div><strong>Slide</strong><span>Go under the high ones</span></div></div><div class="control pause-hint"><kbd>esc</kbd><div><strong>Take a break</strong><span>Pause your run</span></div></div></section>
...
game.entities = [
  { id: -1, kind: 'train', lane: 1, z: 21, y: 0, extra: 0, length: 7 },
  { id: -2, kind: 'train', lane: -1, z: 43, y: 0, extra: 0, length: 7 },
  { id: -3, kind: 'low', lane: 0, z: 33, y: 0, extra: 0, length: .65 },
